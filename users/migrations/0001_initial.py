    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('programacion', models.ForeignKey(default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='programming.programacion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_asis_responsable', models.DateField(default=datetime.datetime.today, verbose_name='Hora asistente responsable')),

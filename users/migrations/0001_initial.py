...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Rol',
            fields=[
                ('rol', models.CharField(max_length=4, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Empleado',
            fields=[
                ('cod_empleado', models.CharField(max_length=11, primary_key=True, serialize=False, unique=True)),
                ('rol', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.rol')),
